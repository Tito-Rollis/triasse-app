...
export default function HeaderComponent() {
    return (
        <div className="w-screen flex flex-wrap ">
            {/* FIRST HEADER */}
            <div className="py-3  px-20 flex justify-end gap-8  bg-grey-100 w-full">
                <div className="flex gap-1 items-center">
                    <Image
                        ...
                        height="16.225"
                    />
                    <p className="text-p text-grey-300">
                ...
                <div className="flex gap-1 items-center">
                    <Image
                        ...
                        height="15.656"
                    />
                    <p className="text-p text-grey-300">+62811 1122 015</p>
                </div>
                <div className="flex gap-1 items-center">
                    <Image
                        ...
                        height="13.158"
                    />
                    <p className="text-p text-grey-300">cs@triasse.com</p>
                </div>
            </div>
            {/* SECOND HEADER */}
            <div className="py-3 px-20 flex w-full justify-between items-center">
                <Image
